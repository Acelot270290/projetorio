...
class AcervoController extends Controller
{
    ...
    {
        /*$acervos = Acervos::select('acervos.id', 'nome_acervo', 'cep_acervo', 'endereco_acervo', 'numero_endereco_acervo', 'bairro_acervo', 'cidade_acervo', 'UF_acervo', 'descricao_fachada_planta_acervo', 'foto_frontal_acervo', 'estado_conservacao_acervo_id', 'titulo_estado_conservacao_acervo', 'ano_construcao_acervo', 'tombamento_id', 'titulo_tombamento', 'seculo_id', 'titulo_seculo', 'especificacao_acervo_id', 'titulo_especificacao_seguranca_obras')//, 'usuario_insercao_id', 'u1.name', 'usuario_atualizacao_id', 'u2.name')
        ...
        ->join('especificacao_seguranca_obras as es', 'es.id', '=', 'especificacao_acervo_id')
        //->join('users as u1', 'u1.id', '=', 'usuario_insercao_id')
        //->join('users as u2', 'u2.id', '=', 'usuario_atualizacao_id')
        ->get();*/
    ...
    public function detalhar(Request $request, $id){
        $acervo = Acervos::select('acervos.id', 'nome_acervo', 'cep_acervo', 'endereco_acervo', 'numero_endereco_acervo', 'bairro_acervo', 'cidade_acervo', 'UF_acervo', 'descricao_fachada_planta_acervo', 'foto_frontal_acervo', 'estado_conservacao_acervo_id', 'titulo_estado_conservacao_acervo', 'ano_construcao_acervo', 'tombamento_id', 'titulo_tombamento', 'seculo_id', 'titulo_seculo', 'especificacao_acervo_id', 'titulo_especificacao_acervo', 'usuario_insercao_id', 'u1.name', 'usuario_atualizacao_id', 'u2.name')
